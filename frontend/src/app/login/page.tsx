    ...
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">Log in to your PageGuard account</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          ...
          <Link href="/signup" className="text-blue-600 hover:text-blue-700 font-medium">Create one for free</Link>
        </p>
      </div>
    </div>
  );
